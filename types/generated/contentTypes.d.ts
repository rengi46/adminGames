...
export interface ApiCheckCheck extends Schema.CollectionType {
  ...
  attributes: {
    regaloEntregado: Attribute.Boolean;
    code: Attribute.UID;
...
export interface ApiFormUserFormUser extends Schema.CollectionType {
  ...
  attributes: {
    NameObligatorio: Attribute.Boolean;
    ApellidoObligatorio: Attribute.Boolean;
    NacimientoObligatorio: Attribute.Boolean;
...
export interface ApiJuegoJuego extends Schema.CollectionType {
  ...
  attributes: {
    Juego: Attribute.String;
    UmbraPremio: Attribute.BigInteger;
...
export interface ApiRankGameRankGame extends Schema.CollectionType {
...
export interface ApiRegaloRegalo extends Schema.CollectionType {
  collectionName: 'regalos';
  info: {
    singularName: 'regalo';
    pluralName: 'regalos';
    displayName: 'Regalo';
  ...
  attributes: {
    Regalo: Attribute.String;
    tienda: Attribute.Relation<
      'api::regalo.regalo',
      'oneToOne',
      'api::tienda.tienda'
    >;
    codigoRegalo: Attribute.UID<'api::regalo.regalo', 'Regalo'>;
    Max: Attribute.BigInteger;
    Inicio: Attribute.Date;
    Fin: Attribute.Date;
    Descripcion: Attribute.Text;
    FinPromo: Attribute.Date;
...
export interface ApiTiendaTienda extends Schema.CollectionType {
...
export interface ApiUsuarioUsuario extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String;
    Email: Attribute.Email;
    dateBirthday: Attribute.Date;
    NumberPhone: Attribute.BigInteger;
    Apellido: Attribute.String;
    Genero: Attribute.Enumeration<['Hombre', 'Mujer', 'Otros']>;
    rank_games: Attribute.Relation<
      'api::usuario.usuario',
      'oneToMany',
      'api::rank-game.rank-game'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::rank-game.rank-game': ApiRankGameRankGame;
      'api::regalo.regalo': ApiRegaloRegalo;
